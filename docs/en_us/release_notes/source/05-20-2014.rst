...
.. note:: 
 ...
 sign up for the edX Release Announcements mailing list [LINK TBP] to get an
 email message when there is a new release.
...
* `edX Data Documentation`_
  ...
  * Added an `event list`_ to the `Tracking Logs`_ section.
...
* This release introduces context-sensitive online help to Studio. You can click
  **Help** in the upper-right corner to get more more information about the
  ...
  You can also expand the panel at the bottom of Studio user interface and use
  the links to access a PDF file of edX course staff documentation, edX Studio
  Author Support, and edX101.
